/**
 * Fuggs Feature Card Component
 * Reusable card component for features
 */

class FuggsFeatureCard extends HTMLElement {
  connectedCallback() {
    const icon = this.getAttribute('icon') || 'ai';
    ...
    this.innerHTML = `
      <div class="feature-card">
        ...
        <h3 class="text-xl font-semibold mb-3 text-gray-900">${title}</h3>
...
customElements.define('fuggs-feature-card', FuggsFeatureCard);
